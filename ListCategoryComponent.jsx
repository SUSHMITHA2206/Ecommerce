                            ...
                            <tbody>
                                {
                                    this.state.categories.map(
                                        ...
                                        <tr key = {category.id}>
                                             ...
                                             <td>
                                                 <button onClick={ () => this.editCategory(category.id)} className="btn btn-primary">Update </button>
                                                 <button style={{marginLeft: "10px"}} onClick={ () => this.deleteCategory(category.id)} className="btn btn-danger">Delete </button>
                                                 <button style={{marginLeft: "10px"}} onClick={ () => this.viewCategory(category.id)} className="btn btn-primary">View </button>
                                             </td>
                                        </tr>
                                    )
                                }
